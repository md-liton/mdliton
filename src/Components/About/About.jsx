  ...
  return (
    <>
          <div className='p-[10px] '>
              <div className='flex items-center border border-2 rounded-lg border-[#ff2770] p-[10px] gap-[50px]'>
                  <div className='w-3/4  '>
                      ...
                      <div className='h-[50px]'>
                          <p className='text-[#45f3ff] font-vollo font-semibold text-[30px] '><span>Mern Stack</span> <span className='text-[#ff2770]'>Developer</span> </p>
                      </div>
                  ...
                  <div className='w-1/4  '>
                      <div className='h-[200px] w-[200px] border border-4 rounded-full border-y-[#ff2770] border-x-[#45f3ff] hover:border-y-[#45f3ff] hover:border-x-[#ff2770] hover:ease-in hover:duration-300'></div>
                  </div>
              </div>

              <div className='flex gap-[50px] mt-[15px] '>
                  <div className='w-2/4 '>
                      <div className='border border-2 rounded-lg border-[#ff2770]  p-[20px]'>
                          <p className='text-white font-vollo font-bold text-[35px] '>Certificate</p>
                          <h5 className='text-[#ff2770] font-vollo font-bold text-[20px] '>MERN Stack Development - (Creative It Institute)</h5>
                          <p className=' font-vollo font-bold text-[13px] text-[#45f3ff]'>(2023 - 2024) - Dhaka , Bangladesh</p>
                          <h5 className='text-[#ff2770] font-vollo font-bold text-[20px] mt-[15px] '>Web Design - (Creative It Institute)</h5>
                          <p className=' font-vollo font-bold text-[13px] text-[#45f3ff]'>(2022) - Dhaka , Bangladesh</p>
                          <h5 className='text-[#ff2770] font-vollo font-bold text-[20px] mt-[15px] '>Diploma in MERN  - (Creative It Institute)</h5>
                          <p className=' font-vollo font-bold text-[13px] text-[#45f3ff]'>(2023 - 2024) - Dhaka , Bangladesh</p>
                      </div>
                  </div>
                  <div className='w-2/4  '>
                      <div className='border border-2 rounded-lg border-[#ff2770]  p-[20px]'>
                          ...
                          <h5 className='text-[#ff2770] font-vollo font-bold text-[20px] '>Degree - (Tongi Govt. College)</h5>
                          <p className=' font-vollo font-bold text-[13px] text-[#45f3ff]'>(2021 - 2025 Runnig) - Gazipur , Bangladesh</p>
                          <h5 className='text-[#ff2770] font-vollo font-bold text-[20px] mt-[15px] '>HSC - (Uttara High School & College)</h5>
                          <p className=' font-vollo font-bold text-[13px] text-[#45f3ff]'>(2018-2020) -Uttara Dhaka , Bangladesh</p>
                          <h5 className='text-[#ff2770] font-vollo font-bold text-[20px] mt-[15px] '>SSC - (Nawab Habibullah Model School & College)</h5>
                          <p className=' font-vollo font-bold text-[13px] text-[#45f3ff]'>(2018) -Uttara Dhaka , Bangladesh</p>
                      </div>
                  </div>
              </div>

              <div className=' border border-2 rounded-lg border-[#ff2770] p-[10px] gap-[50px] mt-[15px] '>
                      ...
                      <div className='flex justify-center gap-[25px] px-[40px] my-[25px]'>
                        <div className=' border border-2 rounded-lg border-[#ff2770] p-[20px] cursor-pointer'>
