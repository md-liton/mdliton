...
const Skills = () => {
  return (
    ...
    <div className='md:flex md:items md:center md:justify-center md:gap-[15px]'>
    ...
    <div className='md:flex md:items md:center md:justify-center md:gap-[15px] 2xl:mt-[20px] mt-[10px]'>
      <div className='border border-[#37B7C3] rounded-lg xl:p-[15px] 2xl:p-[25px] p-[10px] md:w-1/2'>
        <div className='flex items-center gap-[10px] text-white text-[30px]'>
        <SiMongodb />
        <SiExpress />
