            ...
            <form  ref={form} onSubmit={sendEmail}>
              <div className='md:flex items-center gap-[50px]' >
                <div>
                  ...
                  <input onChange={handleName} className='border border-2 rounded-lg border-[#37B7C3] bg-transparent md:p-[10px] p-[5px] text-[#999999]' placeholder='Name' type="text" name='client_name' />
                ...
                <div>
                  ...
                  <input onChange={handleEmail} className='border border-2 rounded-lg border-[#37B7C3] bg-transparent md:p-[10px] p-[5px] text-[#999999]' placeholder='Email' type="email" name='client_email' />
              ...
              <div className='md:flex items-center gap-[50px] md:mt-[25px]'>
                <div>
                  ...
                  <input className='border border-2 rounded-lg border-[#37B7C3] bg-transparent md:p-[10px] p-[5px] text-[#999999] mb-[20px] md:mb-[0px]' placeholder=' Number(optional)' type="text" name='client_number' />
                </div>
                <div>
                  <p className='text-[15px] font-semibold mb-[5px]  text-[#37B7C3] pl-[10px]'>Subject(optional)</p>
                  <input className='border border-2 rounded-lg border-[#37B7C3] bg-transparent md:p-[10px] p-[5px] text-[#999999]' placeholder='Subject(optional)' type="text" name='subject' />
                </div>
              </div>
